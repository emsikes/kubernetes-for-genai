...
| 10 | Optimizing GPU Resources for GenAI Applications | GPU Time-Slicing + DCGM Monitoring | Local / Proxmox |
| 11 | GenAIOps — Data Management and GenAI Automation Pipeline | KubeRay Pipeline + MLflow Tracking | Proxmox |
| 12 | Observability — Getting Visibility into GenAI on K8s | Full LGTM Stack + LangFuse Tracing | EKS / Proxmox |
